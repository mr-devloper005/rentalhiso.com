...
export function EmptyState({ icon: Icon = FolderOpen, title, description, action }: EmptyStateProps) {
  return (
    ...
    >
      <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-2xl border border-border/80 bg-gradient-to-br from-card to-muted/50 shadow-sm">
...
export function NoArticlesFound() {
  return (
    <EmptyState
      ...
      description="We couldn't find any local guides matching your criteria. Try adjusting your filters or search terms."
      action={{ label: 'Browse All Guides', href: '/articles' }}
    />
  )
}
